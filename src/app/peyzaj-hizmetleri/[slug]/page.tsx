...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const service = content.services.peyzaj.serviceTypes.find(
  ...
  return {
    title: `${service.title} | Peston Peyzaj`,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-2xl font-bold mb-4">Neden Profesyonel Peyzaj?</h2>
          <ul className="space-y-4">
            <li className="flex items-start">
              <span className="text-emerald-600 mr-2">•</span>
              <p>Uzman peyzaj mimarları ve deneyimli ekip</p>
            </li>
            <li className="flex items-start">
              <span className="text-emerald-600 mr-2">•</span>
              <p>Modern tasarım ve uygulama teknikleri</p>
            </li>
            <li className="flex items-start">
              <span className="text-emerald-600 mr-2">•</span>
            ...
            <li className="flex items-start">
              <span className="text-emerald-600 mr-2">•</span>
              <p>Sürdürülebilir peyzaj çözümleri</p>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold mb-2">1. Keşif ve Planlama</h3>
              <p className="text-gray-600">
                Uzman ekibimiz alanınızı inceleyerek ihtiyaçlarınızı ve isteklerinizi detaylı şekilde analiz eder.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">2. Tasarım</h3>
              <p className="text-gray-600">
                Alan ölçülerine ve isteklerinize göre özel peyzaj tasarımı hazırlanır.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">3. Uygulama</h3>
              <p className="text-gray-600">
                Onaylanan tasarım profesyonel ekibimiz tarafından titizlikle uygulanır.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">4. Bakım ve Takip</h3>
              <p className="text-gray-600">
                Uygulama sonrası düzenli bakım ve kontrol hizmetleri sağlanır.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-emerald-50 p-8 rounded-lg mt-16 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Hayalinizdeki bahçe ve peyzaj düzenlemesi için hemen bizimle iletişime geçin.
        </p>
        <Link
          href="/randevu"
